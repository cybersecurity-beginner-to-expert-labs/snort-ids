...
function overwrite_rules() {
    ...
    echo -e "\n# Rule to detect NMAP scan from $SOURCE_IP to Nginx container ($NGINX_CONTAINER_IP) on port 21 (FTP)\nalert tcp $SOURCE_IP any -> $NGINX_CONTAINER_IP 21 (msg:\"NMAP Scan to FTP(21) Port Detected\"; flags:S; sid:1000003;)" > $RULES_FILE
